...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.GET ,"/produto/nomeProduto/{nomeProduto}").permitAll()
        ...
        .antMatchers(HttpMethod.PUT ,"/categoria/id/{id}").permitAll()
        .antMatchers(HttpMethod.PUT ,"/produto/id/{id}").permitAll()
        .antMatchers(HttpMethod.DELETE ,"/categoria").permitAll()
        .antMatchers(HttpMethod.DELETE ,"/produto").permitAll()
        .antMatchers(HttpMethod.DELETE ,"/categoria/id/{id}").permitAll()
        .antMatchers(HttpMethod.DELETE ,"/produto/id/{id}").permitAll()
